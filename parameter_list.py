...
R1 = 695_500 * 2.36 # km, radius of the Star
R2 = 69_911 * 1.891      # km, radius of the Planet
e = 0  # Eccentricity of the Earth's orbit
a = 0.035 * AU  # km, semi-major axis of the Earth's orbit / 10
...
Temperature = 10170  # K, temperature of the Star
